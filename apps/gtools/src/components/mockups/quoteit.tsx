    ...
    >
      <div className="flex items-center justify-between px-2.5 py-1.5" style={{ background: "#0f1729" }}>
        <div className="flex items-center gap-2.5">
          ...
          <span className="hidden text-[7px] font-medium text-white/50 sm:inline">
            Dashboard · Quotes · CRM · Catalog
          </span>
        </div>
        <span className="rounded-full px-2 py-0.5 text-[7px] font-semibold text-white" style={{ background: `linear-gradient(90deg, ${accent}, #fb923c)` }}>
          + New Quote
        </span>
      </div>
