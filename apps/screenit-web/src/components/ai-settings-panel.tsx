...
import { Bot, CheckCircle2, Database, FileSearch, LoaderCircle, Mic2, RefreshCw, ShieldCheck } from "lucide-react";
import type { AiConfiguration, AiConnectionStatus } from "@/lib/ai-status";
