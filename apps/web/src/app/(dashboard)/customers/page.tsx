    ...
    <div className="mx-auto max-w-4xl">
      ...
      <div className="mb-4">
        <input
          ...
          className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white outline-none placeholder:text-white/30 focus:border-[#6c5ce7] focus:ring-1 focus:ring-[#6c5ce7]"
        />
      </div>
              ...
              {filtered.map((customer) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center">
                      {triageCount > 0 ? (
                        <span className="rounded-full bg-[#6c5ce7]/10 px-2 py-0.5 text-xs font-medium text-[#6c5ce7]">
                          {triageCount}
                        </span>
                      ) : (
