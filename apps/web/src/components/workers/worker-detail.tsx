          ...
          <div className="space-y-2">
            {topSkills.map((skill) => (
              <div key={skill.id} className="flex items-center gap-2 rounded-lg bg-white/5 px-3 py-2">
                <span className="rounded bg-[#6c5ce7]/20 px-1.5 py-0.5 text-[10px] font-medium text-[#6c5ce7]">
                  {skill.skill_type}
                </span>
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="rounded-lg bg-[#6c5ce7] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#5a4bd4]"
        >
        ...
        <div className="rounded-xl border border-white/10 bg-white/[0.02] p-5 space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white outline-none placeholder:text-white/30 focus:border-[#6c5ce7]"
              />
            </div>
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white outline-none focus:border-[#6c5ce7]"
              >
                {SKILL_TYPES.map((t) => (
          ...
          <div>
            ...
            <textarea
              ...
              rows={8}
              className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white outline-none placeholder:text-white/30 focus:border-[#6c5ce7] font-mono"
            />
          </div>
          <button
            onClick={handleSave}
            disabled={saving || !title.trim() || !content.trim()}
            className="rounded-lg bg-[#6c5ce7] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#5a4bd4] disabled:opacity-50"
          >
