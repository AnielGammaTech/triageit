    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="rounded-lg bg-[#b91c1c] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#7f1d1d]"
        >
      ...
      {showForm && (
        <div className="rounded-xl border border-white/10 bg-white/[0.02] p-5 space-y-4">
          ...
          <button
            ...
            className="rounded-lg bg-[#b91c1c] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#7f1d1d] disabled:opacity-50"
          >
