      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={handleSave}
            disabled={!name.trim()}
            className="rounded-lg bg-[#b91c1c] px-3 py-1.5 text-xs font-medium text-white hover:bg-[#7f1d1d] disabled:opacity-50"
          >
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-lg bg-[#b91c1c] px-4 py-2 text-sm font-medium text-white hover:bg-[#7f1d1d]"
        >
          + Add Rule
        </button>
      </div>
