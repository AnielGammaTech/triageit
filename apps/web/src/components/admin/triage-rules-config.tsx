    ...
    <div className="space-y-4 rounded-xl border border-white/10 bg-white/[0.02] p-5">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={handleSave}
            disabled={!name.trim()}
            className="rounded-lg bg-[#6c5ce7] px-3 py-1.5 text-xs font-medium text-white hover:bg-[#5a4bd4] disabled:opacity-50"
          >
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white placeholder-white/30 outline-none focus:border-[#6c5ce7]"
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          spellCheck={false}
          className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 font-mono text-xs text-white placeholder-white/30 outline-none focus:border-[#6c5ce7]"
        />
      </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-lg bg-[#6c5ce7] px-4 py-2 text-sm font-medium text-white hover:bg-[#5a4bd4]"
        >
          + Add Rule
        </button>
      </div>
